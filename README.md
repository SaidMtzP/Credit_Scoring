...
$$text{scale_pos_weight} = frac{text{Clientes Buenos}}{text{Clientes Malos}} = 4$$
...
*   **Coeficiente de Gini:** **0.8162** ($text{Gini} = 2 times text{ROC-AUC} - 1$). Un Gini > 0.80 clasifica al modelo en un nivel de desempeño *Élite*.
